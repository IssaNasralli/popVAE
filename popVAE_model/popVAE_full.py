...
def create_vae_pipeline_model_simple(patch_size, latent_dim, bands, bands_context, attention=0, reduction_ratio=16, kernel_attention=7):
    # VAE Encoder
    ...
    # Flatten z and concatenate with input_xp
    z_flattened = Flatten()(z)
    z_reshaped = Reshape((1, 1, latent_dim))(z_flattened)  # Reshape z to match spatial dimensions of input_xp
...
def predict_and_reconstruct(model, input_data, profile, output_raster, patch_size, bands, bands_context, batch_size_p, checkpoint_file):
